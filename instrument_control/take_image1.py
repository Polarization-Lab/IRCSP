...
def take_image1(filename):
    ...
    try:
        ...
        print('error in camera 1 aquisition')
        #Close Camera
        camera1.close()
...
def main():
    ...
    path = 'C:\\Users\\khart\\Documents\\Summer2022Campaign\\IRCSP2\\Flights\\Flight07072022\\'
    ...
    name = "Camera1_Capture" + str(count) + ".hdf5"
