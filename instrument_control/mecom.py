...
class MeCom:
    ...
    def __init__(self, serialport="COM24", timeout=1, baudrate=57600,metype = 'TEC'):
        """
    ...
    def get_parameter(self, parameter_name=None, parameter_id=None, *args, **kwargs):
        ...
        vr = self._get(self,parameter_id=parameter_id, parameter_name=parameter_name, *args, **kwargs)
